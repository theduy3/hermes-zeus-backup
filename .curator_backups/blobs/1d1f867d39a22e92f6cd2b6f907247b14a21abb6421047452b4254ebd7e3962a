...
| Fallback `nous`/`hy3-free` | Real free tier this account owns; OpenRouter free entries fail with no key; `opencode-free` is wrong product |
...
FALLBACK = [{'provider': 'nous', 'model': 'hy3-free'}]

...
Use current Quebec/East Coast trip 2026-07-06 to 2026-07-12 date/time (America/Toronto) for “today,” “tomorrow,” and date grouping unless an active Quebec/East Coast trip is clearly detected from Daily notes or Catthew output; if trip is active, use Eastern Time for trip-sensitive family/calendar items and clearly label timezone only when it affects timing.
...
## Today
- ☐ Remind Madame to close credit cards — TD Aeroplan Visa, Amex Gold, Amex Gold Business, Amex Edge Business. Overdue from Jun 2.
- ☐ Check overdue business/admin cards already sent today if you have bandwidth: Clover pricing, KPI Tip, Nail Box photos, SS menu, satisfaction survey form.
- Household: no scheduled events today; groceries pending: Korean pear, bread cheese / other cheese.

## Next 7 Days
- Tue Jun 16 — Victoria: Playgym, 9:15–11:45 AM; Jeanette Zumba reminder, 6:45 PM.
- Wed Jun 17 — Victoria music class 10:30 AM; Playgym 12:30–2:30 PM; immunizations 2:00–2:30 PM. ☐ Call Desjardins for new OM Visa card. ☐ Pay CIBC Aventura 8824. ☐ Weekly Review.
- Fri Jun 19 — Victoria immunizations appointment, 1:30 PM PDT, Ravensong Community Health Centre.
- Sat Jun 20 — Victoria Playgym 9:15–11:45 AM. ☐ Portfolio Update. ☐ One Stock Learning.
- Mon Jun 22 — ☐ Pay CIBC Aeroplan 6929.

## Waiting / Watch
- Sent-but-not-done personal task cards still open today: Remind Madame close cards, Check Clover pricing, Guide employee exchange distribution, Set Up Nail Box, KPI Tip, Memo addon policy, Laviestella preauth payment, Fix SS menu, Satisfaction Survey form, Update websites.

## Done / Cleared
- Cleared since yesterday: OfF Piknic at Parc Jean-Drapeau; RBC Avion → BA Avios 30% bonus transfer.

Generated 19:21 · Personal tasks

...
## Today
- 7:00 AM — Fresh Prep package drop.
- ☐ Household: collapse baby crib, move dining-room cabinet to master bedroom, build cabinet.
- ☐ Weekly Review is still pending from yesterday.
- ☐ Clear stale admin cards if possible: Laviestella pre-authorized taxes/strata, Fix SS Menu, employee exchange guide.

## Next 7 Days
- Sat May 30 — ☐ Portfolio Update; ☐ One Stock Learning.
- Sun May 31 — Save-On-Foods “$1.49 Day Tuesday” check runs.
- Mon Jun 1 — ☐ Close BMO Porter Mastercard.
- Tue Jun 2, 6:45 PM — Jeanette Zumba at Roundhouse.
- Thu Jun 4 — ☐ Pay CIBC Aeroplan 0876.

## Waiting / Watch
- Sent-but-not-done cards still open: Build Cabinet; Collapse Baby Crib and Move Cabinet; Weekly Review.
- Older admin cards also still open: Set Up Nail Box for Photos; Memo Addon $15+; Guide Employee Exchange Distribution.

## Done / Cleared
- Pay TD Aeroplan Biz 9716 cleared yesterday.
- Pay RBC Avion 7760 cleared yesterday.

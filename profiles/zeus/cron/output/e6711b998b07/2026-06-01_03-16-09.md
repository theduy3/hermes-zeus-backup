...
## Today
- ☐ Set up pre-authorized payment for Laviestella taxes and strata fees — overdue.
- ☐ Check Clover software plan pricing — overdue from Friday.
- ☐ Clean up stale admin/salon tasks if you have a short admin block: Maily/Charlesbourg/Rivières website update, SS menu, satisfaction survey form.
- No household/family appointment found for today.

## Next 7 Days
- Tue Jun 2 — Victoria Playgym, 9:15–11:45 AM, Roundhouse.
- Tue Jun 2 — Jeanette Zumba reminder, 6:00 PM; class at 6:45 PM.
- Wed Jun 3 — Victoria music class, 10:30 AM; Playgym, 12:30–2:30 PM.
- Wed Jun 3 — ☐ Weekly Review due.
- Thu Jun 4 — ☐ Pay CIBC Aeroplan 0876, one week before due date.
- Sat Jun 6 — Victoria Playgym, 9:15–11:45 AM.
- Mon Jun 8 — Arrive at YVR by 8:25 PM for F8106 to Montreal; BMO Mastercard 6526 and CIBC Costco 7219 also come due.

## Waiting / Watch
- Sent-but-not-done task cards still open: Weekly Review, Clover pricing, Laviestella pre-authorized payment, nail box/photos, KPI Tip, SS Menu.
- Older admin backlog remains visible in Obsidian; many are stale rather than time-specific.

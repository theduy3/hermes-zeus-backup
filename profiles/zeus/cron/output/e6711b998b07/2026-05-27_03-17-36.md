...
- ☐ Pay TD Aeroplan Biz 9716 — card due on May 30.
- ☐ Weekly Review.
- ☐ Build cabinet; collapse baby crib / move cabinet is still open.
- ☐ Grocery list from Catthew: Korean pear, ghee.

## Next 7 Days
- Sat, May 30 — Portfolio Update.
- Sat, May 30 — One Stock Learning.

## Waiting / Watch
- Sent task cards still not done: Collapse Baby Crib and Move Cabinet; Guide to Distribute to Employees: Exchange; Set Up Nail Box for Photos; Fix SS Menu.

## Done / Cleared
- Recently cleared: Pay RBC Avion 7760; KPI Tip; Pay CIBC Aeroplan 6929; Send Chelsea Birthday Video; Provide Wylios Discord credentials.

Generated 03:17 · Personal tasks

...
## Today
- ☐ Weekly Review — overdue from Wednesday.
- ☐ Remind Madame to close credit cards — overdue from Jun 2.
- ☐ Grocery remaining: Korean pear; bread cheese / other cheese.
- ☐ Pick one stale admin task to clear: Check Clover pricing, Fix SS Menu, or Set Up Nail Box for Photos.

## Next 7 Days
- Sat Jun 13 — Victoria: Playgym, 9:15–11:45 AM, Roundhouse.
- Sat Jun 13 — ☐ Attend OfF Piknic at Parc Jean-Drapeau.
- Sat Jun 13 — ☐ Pay CIBC Costco 4276.
...
- Wed Jun 17 — ☐ Pay CIBC Aventura 8824.
- Thu Jun 18 — Victoria: Playgym, 9:15–11:45 AM.

## Waiting / Watch
- Sent-but-not-done cards still open: Weekly Review, Remind Madame to close credit cards, Check Clover pricing, Fix SS Menu, Set Up Nail Box for Photos.
- Household briefing source is stale: latest Catthew output found was Jun 8; direct Catthew files show the Jun 17 immunizations task.

## Done / Cleared
- RBC Avion Rewards → British Airways Avios 30% bonus marked done today.

...
Use current Pacific date/time (America/Vancouver) for “today,” “tomorrow,” and date grouping unless an active Quebec/East Coast trip is clearly detected from Daily notes or Catthew output; if trip is active, use Eastern Time for trip-sensitive family/calendar items and clearly label timezone only when it affects timing.
...
## Today
- 10:30 AM — Adavid: head to The Victor with flowers, gifts, and Korean deco.
- 11:45 AM — Jeanette: head out; Dad picks up Jeanette + Victoria. Bring baby food: fruit, pancake, 떡뻥. Set up dolsang on arrival.
- ☐ Check Clover Software Plan Pricing — overdue from May 29.
- ☐ Portfolio Update + One Stock Learning — weekly tasks overdue from yesterday.
- ☐ Clear one admin/business stale task if you have bandwidth: Fix SS Menu, staff memo, or Laviestella pre-authorized payments.

## Next 7 Days
- Mon Jun 1 — Close BMO Porter Mastercard reminder.
- Tue Jun 2 — Victoria Playgym, 9:15–11:45 AM; Jeanette Zumba reminder at 6:00 PM for 6:45 PM class.
- Wed Jun 3 — Victoria Music class, 10:30 AM; Playgym, 12:30–2:30 PM; ☐ Weekly Review due.
- Thu Jun 4 — Victoria Playgym, 9:15–11:45 AM; ☐ Pay CIBC Aeroplan 0876 due.
- Sat Jun 6 — Victoria Playgym, 9:15–11:45 AM.

## Waiting / Watch
- Sent-but-not-done cards still open: Clover pricing, One Stock Learning, Portfolio Update, Set Up Nail Box for Photos.
- Older stale cards are still pending in Obsidian: Laviestella payments, staff addon memo, employee exchange guide, website updates.

## Done / Cleared
- KPI Tip was marked done yesterday.

Generated 03:15 · Personal tasks

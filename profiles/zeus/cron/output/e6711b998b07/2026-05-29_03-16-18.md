...
## Today
- ☐ Handle overdue household setup: collapse baby crib, move current cabinet to master bedroom, build cabinet.
- ☐ Finish gift wrapping and iron/alter baby’s dress — household items still overdue from Catthew.
- ☐ Clear overdue admin/finance cards: Laviestella taxes/strata pre-auth, SS menu, employee exchange guide, nail photo box.
- ☐ Weekly Review is overdue from Wednesday.
- ☐ Pay TD Aeroplan Biz 9716 if not already settled — task file still pending.

## Next 7 Days
- Sat May 30 — Victoria: Playgym, 9:15–11:45 AM, Roundhouse Community Centre.
- Sat May 30 — ☐ Portfolio Update; One Stock Learning.
- Sun May 31 — ☐ Weekly measurements check-in.
- Mon Jun 1 — ☐ Close BMO Porter Mastercard reminder.
- Tue Jun 2 — Victoria: Playgym, 9:15–11:45 AM; Jeanette Zumba reminder at 6:45 PM.
- Wed Jun 3 — Victoria: Music class 10:30 AM; Playgym 12:30–2:30 PM.
- Thu Jun 4 — Victoria: Playgym, 9:15–11:45 AM; ☐ Pay CIBC Aeroplan 0876.

## Waiting / Watch
- Sent-but-not-cleared task cards: Build Cabinet, Collapse Baby Crib and Move Cabinet, Weekly Review.
- Several old admin/salon tasks are still pending in Obsidian; I surfaced only the most actionable ones above.

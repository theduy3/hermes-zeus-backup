...
- 💰 Finance shared: June credit-card payment cadence is active: first key payments are Jun 4, Jun 8, and Jun 11.
- 💰 Finance shared: Several overdue admin/tax items remain: Laviestella taxes/strata PAD, Ongles Rivieres year-end package, Jenny loan agreement, Square $200 claim, Desjardins account, Clover pricing.
- 💰 Finance shared: Registered portfolio has high cash (~$92.7k / ~46%) and high NVDA concentration (~36–37%).

- 📈 Investment shared: Portfolio is about ~$199–200k CAD, with ~$106k invested and ~$92–93k cash.
- 📈 Investment shared: Main risk is NVDA concentration: 241 shares, roughly ~$72–74k CAD, about 36% of portfolio.
- 📈 Investment shared: No confirmed trades recorded; likely next decision is cash deployment/rebalancing vs concentration reduction.

- 🔁 Cross-agent implications: Don’t deploy all cash aggressively until June card payments and overdue admin/tax tasks are under control.
- 🔁 Cross-agent implications: Any portfolio move should start with exact balance review, then target allocation for cash / NVDA / broad ETFs / FHSA.
- 🔁 Cross-agent implications: Montreal Jun 8–15 may reduce admin bandwidth, so pre-pay/automate June card payments where possible.

- ⚠️ Needs Duy: Decide whether to prioritize overdue admin cleanup first, or portfolio allocation plan first; both are currently blocking clean next steps.

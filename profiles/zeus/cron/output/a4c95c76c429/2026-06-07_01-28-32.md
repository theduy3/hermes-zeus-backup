...
- 💰 Finance shared: June card payments start immediately: BMO + CIBC Costco due-action Jun 8, then CIBC Kitty Jun 11, CIBC Costco 4276 Jun 13, more through Jun 27.
- 💰 Finance shared: Overdue admin remains: Madame card closures, portfolio update, Laviestella tax/strata autopay, Ongles Rivieres year-end tax package.
- 💰 Finance shared: Liquidity context: $2,748 biweekly income, $2,000 monthly rent, ~$92.7k registered cash, no confirmed near-term registered withdrawal need.
- 📈 Investment shared: Portfolio cash is very high: ~$92.7k / ~46% registered portfolio, creating cash drag.
- 📈 Investment shared: NVDA remains the main concentration risk: ~$71–74k, roughly 36–37% of portfolio and ~67% of invested holdings.
- 📈 Investment shared: Watch AI/mega-cap overlap, USD/CAD exposure, and FHSA deployment decision.
- 🔁 Cross-agent implications: Don’t force portfolio trades until June payment/admin obligations are controlled.
- 🔁 Cross-agent implications: If deploying cash, bias toward staged/diversified deployment rather than adding more AI/mega-cap tech.
- 🔁 Cross-agent implications: Montreal Jun 8–15 may reduce admin bandwidth, so urgent payments/admin should be handled early.
- ⚠️ Needs Duy: Decide whether to prioritize admin cleanup/liquidity first before any registered cash deployment.
- ⚠️ Needs Duy: Decide FHSA direction based on home-purchase timeline.
- ⚠️ Needs Duy: Decide whether to trim, hold, or set a max position size for NVDA.

...
📌 Tomorrow
☐ Build the cabinet [1]
☐ Victoria music class at 10:30 AM [2]
☐ Pay TD Aeroplan Biz 9716 (due on the 30th) [3]
☐ Do Weekly Review [4]
☐ Buy Korean pear and ghee if still needed [5]

📅 Next 7 Days
☐ One Stock Learning due Saturday [6]
☐ Portfolio Update due Saturday [7]
☐ Weekly Portfolio Briefing runs Sunday [8]
☐ Close BMO Porter Mastercard reminder runs Monday [9]

🕒 Timezone
☐ Pacific Time remains the working context; Montreal trip is noted for June 8 with YUL return June 15, but the prior Orchestrator timezone switch attempt failed due default profile auth/API key issue [10]

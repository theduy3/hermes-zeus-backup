...
# 🌙 Evening Task Status — Wednesday, 2026-05-27

✅ Completed Today
- 2 completed via ✅ button today
- Pay TD Aeroplan Biz 9716 (due on the 30th)
- Pay RBC Avion 7760 (due date on the 3rd)

📬 Sent, Waiting
- 19 sent cards still waiting
...
⏳ Still in Drip Queue
- 11 remaining due/overdue Obsidian tasks
- Build Cabinet
- Weekly Review
...
📌 Tomorrow
☐ Move the current cabinet from the dining room to the master bedroom [1]
☐ Pick up Korean pear and ghee if doing a grocery run [2]

📅 Next 7 Days
☐ One Stock Learning due Saturday, 2026-05-30 [3]
☐ Portfolio Update due Saturday, 2026-05-30 [4]
☐ Weekly Portfolio Briefing runs Sunday, 2026-05-31 [5]
☐ Close BMO Porter Mastercard reminder on Monday, 2026-06-01 [6]

🕒 Timezone
☐ Quebec/Montreal trip context updated: use Eastern Time for trip-sensitive scheduling June 8–15, then switch back after return [7]

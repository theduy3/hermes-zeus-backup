...
🏠 Family / Catthew
☐ Costco run: braising short ribs — priority
☐ Costco run: general household restock — TBD

🕒 Timezone
☐ Use Eastern Time for Montreal/Laval/Quebec City appointments during the Quebec/East Coast trip; orchestrator timezone context is updated, no return date found yet.

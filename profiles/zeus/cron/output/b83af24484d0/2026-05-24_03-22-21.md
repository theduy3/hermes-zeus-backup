...
# ✅ Tasks — Sunday, 2026-05-24

⚠️ Overdue
☐ Visit MacGILLYCUDDY'S (due: 2026-05-21)
☐ Apply For ESTA (due: 2026-05-22)
☐ Book Session With Mary Spa (due: 2026-05-22)
☐ Pay CIBC Aeroplan 6929 (due date on the 29th) (due: 2026-05-22)
☐ Send Chelsea Birthday Video (due: 2026-05-22)

📌 Today
☐ Pay TD 1st Class 7243 (due on the 1st) (due: 2026-05-24)

🏠 Family / Catthew
☐ Costco run: braising short ribs, eggs, milk, yogurt, salad greens or spinach, Korean pear, ghee

🕒 Timezone
☐ Hermes Orchestrator timezone switch to Eastern was attempted but failed due invalid DeepSeek API key; fix default profile auth so trip-sensitive scheduling can update.

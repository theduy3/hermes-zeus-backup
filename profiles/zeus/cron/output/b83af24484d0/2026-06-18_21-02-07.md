...
You are preparing Zeus's Daily Evening Briefing for Duy at 9:00PM Vancouver/PDT time.
...
Use current Vancouver/PDT time date/time (America/Vancouver) for “today,” “tonight,” “tomorrow,” and date grouping unless a clearly active Vancouver/PDT time is detected. If a trip is active, use PDT for trip-sensitive family/calendar items and clearly label the timezone only when it affects a task.
...
2. Obsidian: read the latest Daily note from `/vault/Daily/` for today's Vancouver/PDT time date; if today's note doesn't exist, read the most recent one. Extract Tomorrow and This Week. Skip Later/No Date unless urgent.
...
Travel/timezone trigger: while reading Catthew + Daily note, detect any upcoming/current trip to Quebec, Montreal, Laval, Quebec City, East Coast, PDT, YUL/YQB, or related flight/hotel/travel wording. If detected, trigger Hermes Orchestrator (default profile) to switch trip-sensitive scheduling/briefings from Vancouver/PDT time to PDT for the trip window, and to switch back after return if a return date is visible. If Duy appears back in Vancouver/BC/Vancouver/PDT time with no active Vancouver/PDT time context, trigger Hermes Orchestrator to switch Zeus briefing schedules and timezone context back to Vancouver/PDT time. Use terminal:
`hermes --profile default chat -q "Duy has an upcoming/current Vancouver/PDT time detected: [clean trip details + dates if known]. Please update Hermes Orchestrator timezone context for trip-sensitive scheduling/briefings to PDT during the trip, and plan switch-back after return. Keep Duy informed only if action is needed."`
...
# 🌙 Evening Task Status — Thursday, 2026-06-18

✅ Completed Today
- 2 completed via ✅ button today: Follow Korea Republic: Mexico vs Korea Republic; Follow World Cup: Canada vs Qatar
...
📌 Tomorrow
☐ Victoria immunizations appointment at 1:30 PM, Ravensong Community Health Centre [1]  
☐ Follow World Cup: Brazil vs Haiti [2]  
☐ Follow World Cup: USA vs Australia [3]  
☐ Restock household groceries: Korean pear, broccoli, yam/sweet potato, ground beef, grater, cheese [4]

📅 Next 7 Days
☐ Saturday: Victoria Playgym 9:15–11:45 AM, then family BBQ at Jericho Beach 11:00 AM [5]  
☐ Sunday: weekly finance sync + personal finance report + portfolio briefing [6]  
☐ Pay CIBC Aeroplan 6929 by Monday, June 22 [7]  
☐ Wednesday: TD chequing mortgage buffer check for Laval property; also pay TD 1st Class 7243 [8]  
☐ Set up pre-authorized payment of SS rent by Thursday, June 25 [9]

🕒 Timezone
☐ No timezone action needed: Vancouver/PDT active; Quebec/Montreal trip July 6–12 was already detected for trip scheduling [10]

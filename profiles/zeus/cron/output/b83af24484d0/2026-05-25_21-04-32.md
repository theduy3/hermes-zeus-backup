...
# 🌙 Evening Task Status — Monday, 2026-05-25
...
📬 Sent, Waiting
- 21 cards sent, not completed
- Collapse Baby Crib and Move Cabinet
- Pay TD 1st Class 7243 (due on the 1st)
...
⏳ Still in Drip Queue
- 0 remaining due/overdue Obsidian tasks waiting to be sent

📌 Tomorrow
☐ Restock groceries: Korean pear and ghee [1]

📅 Next 7 Days
☐ Wednesday, May 27 at 10:30 AM — Victoria music class [2]
☐ June 1 — Close BMO Porter Mastercard [3]

🕒 Timezone
☐ Keep scheduling context on Pacific Time; no active Quebec/East Coast trip detected from available sources [4]

...
§
All profiles use openai-codex (OAuth ~/.hermes/auth.json), model gpt-5.5. User wants no Anthropic/OpenRouter/non-OpenAI. Config: model.provider=openai-codex, model.default=gpt-5.5, providers:{}.
§

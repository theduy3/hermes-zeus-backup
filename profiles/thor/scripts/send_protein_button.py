#!/usr/bin/env python3
"""Send Thor protein reminder with a Telegram inline Log button.
...
TEXT = os.environ.get("THOR_PROTEIN_REMINDER_TEXT", "🥤 Protein time — 50g")
...
def main() -> int:
    ...
    payload = {
        ...
        "reply_markup": json.dumps({
            "inline_keyboard": [[
                {"text": "✅ Log protein drink", "callback_data": "wl:protein:50"},
                {"text": "More", "callback_data": "wlm:protein:50"},
            ]]
        }),
    }
